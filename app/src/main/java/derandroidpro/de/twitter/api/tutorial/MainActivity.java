...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView iv1;
    FrameLayout tweetViewContainer;
    ...
    private void setUpUi(){
        ...
        tweetViewContainer = (FrameLayout) findViewById(R.id.tweetViewContainer);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == PICK_FILE_REQ_CODE && resultCode == RESULT_OK){
            ...
            if(tweetMediaFile.length() >5242880){
                ...
                tweetViewContainer.setVisibility(View.GONE);
    ...
    private void displayTweet(Tweet tweet){
        /*TweetUtils.loadTweet(725913299594829824L, new Callback<Tweet>() {
            @Override
            public void success(Result<Tweet> result) {
                CompactTweetView compactTweetView = new CompactTweetView(MainActivity.this, result.data); */
                CompactTweetView compactTweetView = new CompactTweetView(MainActivity.this, tweet);
                compactTweetView.setTweetActionsEnabled(true);
                tweetViewContainer.setVisibility(View.VISIBLE);
                tweetViewContainer.addView(compactTweetView);
           /* }
